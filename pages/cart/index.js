                    ...
                    <div key={product._id} className="mt-8">
                      <ul className="space-y-4">
                        <li className="flex items-center justify-between gap-4">
                          ...
                          <div>
                            <h3 className="max-w-md text-md text-text">{product.title}</h3>

                            <dl className="mt-0.5 space-y-px text-[10px] text-text">
                              <p>Rps. {cartProducts.filter(id => id === product._id).length * product.price}</p>
                            </dl>
                          </div>
                    ...
                    <div className="max-w-md space-y-4 ">
                      <dl className="space-y-0.5 text-md text-gray-700">
                        ...
                        <div className="flex justify-between">
                          <dt>Subtotal</dt>
                          <dd>Rps. {formatPrice(total)}</dd>
                        </div>

                        <strike className="flex justify-between">
                          <dt>GST</dt>
                          <dd>Rps. {formatPrice(total / 1000)}</dd>
                        </strike>
        ...
        {!products.length ? (
          ...
          <div className="mt-16 md:1/3 md:mt-6">
            <header className="flex flex-col w-full text-start">
              ...
              <p className="mt-2 text-lg text-text">We use your account details for shipping.</p>
            </header>
  ...
  return <>
    <div className="grid h-screen px-4 bg-white place-content-center">
      <div className="text-center">
        ...
        <p className="mt-4 text-2xl text-text">You should sign Up to view cart Items</p>
