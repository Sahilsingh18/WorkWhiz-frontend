...
export default function Header() {
  ...
  return <>
    <header className="sticky top-0 z-40 w-full px-2 bg-white md:px-4">
      <div
        className="flex items-center h-16 gap-8 mx-auto border-b max-w-screen-2xl border-primary border-opacity-40"
      >
        <Link className="flex items-center gap-1 text-lg font-medium text-text hover:text-primary " href="/">
            ...
            <ul className="flex items-center gap-6 text-md">
              ...
              <li>
                <select className={`text-accent transition hover:text-accent/75 ${pathname === ('/categories') ? 'text-primary' : ""} `} href="/categories">
                  ...
                  <option value="1">allServices</option>
                </select>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flow-root ml-4 lg:ml-4">
              <Link href="/cart" className="flex items-center p-2 -m-2 group">
                ...
                <span className="ml-2 font-bold text-md text-primary group-hover:text-text">{cartProducts.length}</span>
