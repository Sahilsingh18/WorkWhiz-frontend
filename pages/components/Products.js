                ...
                <div className="p-1">
                  ...
                  <div className="relative p-3 border-t">
                    <Link href={'/products/' + product._id}>
                      <h3
                        className="text-gray-700 truncate text-md group-hover:underline group-hover:underline-offset-4"
                      >
                        {product.name}
                      </h3>
                    </Link>
                    ...
                    <div className="mt-1.5 flex items-center justify-between text-text">
                      <p className="tracking-wide text-primary">Rps. {formatPrice(product.price)}</p>
